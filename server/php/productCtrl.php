...
class ProductCtrl extends Controller {
    ...
    public static function getOpenFoodData($id) {
        ...
        if (isset($openData->product) && $openData->product->id != "" && $openData->product->product_name != "") {
            $openData = $openData->product;

            $data['id'] = $openData->code;

            if (isset($openData->product_name_fr) && $openData->product_name_fr != "") $data['name'] = $openData->product_name_fr;
    ...
    protected function getFields() {
        return array('id' => true, 'name' => true, 'image' => true);
    }
}
